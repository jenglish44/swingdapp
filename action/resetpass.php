...
// Additional headers
$headers .= 'To: '.$r['user_name'].' <'.$to.'>' . "\r\n";
$headers .= 'From: Swing Data Mobile App <admin@swingd.com>' . "\r\n";
...
// Mail it
		...
		case 'userreset':
			...
			else
			{
				...
				$to=$_REQUEST['u'];
				$subject='Swing Data - Reset password';
// message
$message = "
<html>
<head>
  <title>Swingd Mobile app - Reset Password</title>
</head>
<body>
	<p>Hello ".$r['user_name']."!</p>
  <p>Your password is changed successfully. New password is 
  : ".$_REQUEST['p']."</p>
  <br/><br />
  Copyright &copy; SwingD
</body>
